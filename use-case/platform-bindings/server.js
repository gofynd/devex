...
// import ApplicationClient from '@gofynd/fdk-client-javascript/sdk/application/ApplicationClient';
// const ApplicationClient = require('@gofynd/fdk-client-javascript/sdk/application/ApplicationClient')
...
const config = new ApplicationConfig({
    applicationID: "669c0da14c6bf176610aaeb6",
    applicationToken: "wQ9hhcNC5",
...
app.post("/api/order", async (req, res) => {
    console.log("shipment_id", req.body.shipment_id);
